...
const Login = () => {
  ...
  const preLoginMessage = location.state?.message || "";
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const hasPendingBooking = Boolean(
        sessionStorage.getItem("pendingRideBooking"),
      );
      if (hasPendingBooking) {
        navigate("/", { replace: true, state: { resumeRide: true } });
      } else {
        navigate(redirectTo);
      }
    } catch (err) {
    ...
    >
      ...
      >
        <div style={{ marginBottom: "2rem" }}>
          ...
          >
            Log in to your TaxiNova account
          </p>
        </div>

        {preLoginMessage && !error && (
          <div
            style={{
        ...
        <form
          onSubmit={step === 1 ? handleInit : handleLogin}
